                            ...
                            <div class="inn-title">
                              ...
                              <section class="fillter">
                                 ...
                                 <div class="row mtr">
                                    ...
                                    <div class="col-md-6">
                                        <div class="container">
                                            <input type="checkbox" class="ch2"> &nbsp;Exclude Active/upcoming members  
                                        </div>
                                    </div>
                                </div>
                                </section>
                                        ...
                                        <div class="col-md-2 col-md-6">
                                            <button class="btn btn-success btn1">APPLY FILTER</button>
                                        </div>
                                        <div class="col-md-2 col-sm-6">
                                            <button class="btn btn-success btn1">APPLY CLEAR</button>
                                        </div> -->
                                    ...
                                    <table class="table table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Last Week Status</th>
                                                <th>Membership Price</th>
                                                <th>Invoice No</th>
                                                <th>Discount Given</th>
                                                <th>Total Balance Due</th>
                                                <th>Closed By</th>
                                                <th>Reference Given By</th>
                                                <th>Actions</th>
                                            </tr>
                                        </thead>
                                        <tbody>
